        ...
        <div class="flex flex-col ">
            ...
            <div class="my-6">
                ...
                <div>
                    ...
                    <br></br>
                    <p class="text-lg text-gray-600">En <span class="text-[#5A3A1B] font-semibold">Aroma Molido</span> no solo vendemos café, sino que buscamos transmitir una cultura, un momento de pausa y disfrute en la rutina diaria. Queremos acompañarte en cada taza, desde el primer aroma hasta el último sorbo.</p>
                    <br>
