                ...
                <form class="max-w-sm mx-auto">
                    ...
                    <label for="remember" class="flex items-center mb-5">
                        <input id="remember" type="checkbox" value=""
                            ...
                            required />
                        <p class="ms-2 text-sm font-medium text-heading select-none">Estoy de acuerdo con los <a
                                href="/terminos-y-condiciones"
                                class="font-medium text-fg-brand hover:underline">términos y condiciones</a>.</p>
                    </label>
                    <button type="submit"
