    ...
    <section class="bg-white py-12 px-6">
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div
                    class="bg-[#F3E5D7] p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105 border border-[#D6B38C] hover:bg-[#E4C7A7]">
                ...
                <div
                    ...
                    <ul class="space-y-3 text-[#5A3A1B]">

                        <li class="flex items-center gap-3">
                            <img src="{{asset('images/comercializacion/mercado-pago.png')}}" alt="MercadoPago"
                                class="w-6 h-6 object-contain">
                            <span>MercadoPago</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{asset('images/comercializacion/visa.png')}}" alt="Visa"
                                class="w-6 h-6 object-contain">
                            <span>Visa</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{asset('images/comercializacion/masterCard.png')}}" alt="Mastercard"
                                class="w-6 h-6 object-contain">
                            <span>Mastercard</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{asset('images/comercializacion/naranja.png')}}" alt="Naranja"
                                class="w-6 h-6 object-contain">
                            <span>Naranja</span>
                        </li>
                    </ul>
                ...
                <div
                    ...
                    <ul class="space-y-3 text-[#5A3A1B]">
                        ...
                        <li class="flex items-center gap-3">
                            <img src="{{asset('images/comercializacion/oca.png')}}" alt="OCA"
                                class="w-6 h-6 object-contain">
                            <span>OCA</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{asset('images/comercializacion/andreani.png')}}" alt="Andreani"
                                class="w-6 h-6 object-contain">
                            <span>Andreani</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{asset('images/comercializacion/correo-arg.png')}}" alt="Correo Argentino"
                                class="w-6 h-6 object-contain">
