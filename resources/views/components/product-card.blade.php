<div>
    <div
        class="bg-white border border-default-medium rounded-base shadow-md hover:shadow-lg hover:scale-105 transition duration-300">
        ...
        <div class="p-5">
            ...
            <div class="flex gap-2">
                <button class="hover:bg-brand border-1 transition duration-700 hover:border-0 rounded-xl w-full py-2">
