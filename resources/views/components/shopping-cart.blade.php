<div id="default-modal-cart" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative  w-full h-screen">
        <!-- Modal content -->
        <div
            class="relative flex flex-col min-h-screen bg-neutral-primary-soft border border-default rounded-l-base shadow-sm p-4 pb-10 md:pb-0 md:p-6">
            <!-- Modal header -->
            ...
            <div
                class="max-w-md mx-auto my-12 p-8 bg-stone-50 border-2 border-dashed border-stone-200 rounded-[2.5rem] text-center">
                <div
                    class="inline-flex items-center justify-center w-20 h-20 bg-amber-100 text-amber-600 rounded-full mb-6 animate-bounce">
                ...
                <p class="text-stone-600 mb-6 italic">
                    Estamos ajustando nuestra molienda digital. Muy pronto podrás pedir tus granos y blends favoritos
                ...
                <span class="text-xs font-medium text-stone-400 uppercase tracking-widest">Fase de Producción:
                    75%</span>
            </div>
            <!-- Modal footer -->
